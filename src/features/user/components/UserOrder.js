...
<h1 className="text-4xl font-bold tracking-tight text-gray-900 my-4">Order # {order.id}</h1>
<h3 className="text-xl font-bold tracking-tight text-red-900 my-4">Order Status : {order.status}</h3>
<div className="flow-root">
 ...
 <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
   ...
   <div
     className="flex justify-between gap-x-6 py-5 border-solid border-2 border-gray-300 px-4 ">
